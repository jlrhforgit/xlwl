...
public class SHA1 {
	...
	/*
	 * private static int bit_rol(int num, int cnt) { return (num << cnt) | (num >>>
	 * (32 - cnt)); }
	 */
	...
	/*
	 * private static void dotest() { String key = "key"; String data = "data";
	 ...
	 * hex_hmac_sha1(key, data)); System.out.println("b64_hmac_sha1(" + key + "," +
	 * data + ")=" + b64_hmac_sha1(key, data)); System.out.println("str_hmac_sha1("
	 * + key + "," + data + ")=" + str_hmac_sha1(key, data)); }
	 */
...
//		String str = SHA1.hex_sha1("000000");
