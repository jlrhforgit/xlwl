...
public class AliMessageSend {
	...
	private static String		mobile			= "15806629663" ;
	
	private static String		accessKeyId		= "LTAIGURNvp4EbIfD" ;
	
	private static String		accessKeySecret	= "mw45VRFRrueBeD3dUazzjYasVB1VhJ" ;
	
	private static String		signName		= "雪落无声" ;
	
	private static String		templeteCode	= "SMS_166866007" ;
